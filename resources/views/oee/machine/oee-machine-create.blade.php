    ...
    <div class="col-xl-6">
        <div class="white_card mb_30 shadow pt-4">
            <div class="white_card_body">
                <div class="">
                    <div>
                        <form action="{{ route('oee.machine.store') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="">Display Ident</label>
                                <input type="text" value="{{ old('ident') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('index') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" value="{{ old('target_defect_rate') }}"
                            ...
                            <div class="form-group">
                                <label for="">Target Effeciency</label>
                                <input type="number" step="0.01" value="{{ old('target_effeciency') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" value="{{ old('cycle_time') }}"
