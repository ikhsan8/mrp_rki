            ...
            <div class="white_card mb_30 shadow pt-4">
                <div class="white_card_body">
                    <div class="form-group">
                        ...
                        <select name="machine_name" class="form-control" id="">
                            ...
                            <option value="{{ $machine->id }}" 
                                {{ (old('machine_id') ? old('machine_id')[0]: '') == $machine->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('alarm_name')}}" class="form-control @error('alarm_name') is-invalid @enderror" name="alarm_name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('alarm_tag')}}" class="form-control @error('alarm_tag') is-invalid @enderror" name="alarm_tag">
