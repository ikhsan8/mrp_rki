    ...
    <div class="col-xl-12">
        <div class="card_box position-relative mb_30 white_bg  shadow bd-0 rounded-20  ">
            <div class="white_box_tittle" style="padding:10px">
                <button class="btn-sm btn-success mb-2 float-right" onclick="screenShoot('main-trending2', '{{$machine->ident}}')"><i class="fa fa-download" aria-hidden="true"></i></button>
                <div class="main-title2 text-center pt-1">
                    <h6 class="mb-2 nowrap" style="font-size: 18px;">Trending Detail Effeciency <span style="font-size: 18px; color:red;">{{$machine->ident}}</span></h6>
                </div>
            </div>
...
<script>
    ...
    const getApiTrending = async () => {
        ...
        try {
            ...
            resp.data.all_values.forEach(vlues => {
                vlues.data.forEach(dts => {
                    ...
                    dts.forEach(dtl => {
                        ...
                        if (machine.ident.slice(0, 2) == 'MA') {
                            production_efficiency.push(vll.production_efficiency)
                            production_productivity.push(vll.production_productivity)
            ...
            if (machine.ident.slice(0, 2) == 'MA') {
                option.series[0].data = resp.data.production_efficiency
                option.series[1].data = resp.data.production_productivity
                option.series[2].data = resp.data.production_efficiency_target
                option.series[3].data = resp.data.st1
                option.series[4].data = resp.data.st2
                option.series[5].data = resp.data.st3_height
                option.series[6].data = resp.data.st3_noball
                option.series[7].data = resp.data.st3_twoball
                option.series[8].data = resp.data.st5_height
                option.series[9].data = resp.data.st5_high
                option.series[10].data = resp.data.st5_low
                option.series[11].data = resp.data.st8_high
                option.series[12].data = resp.data.st8_low
                option.series[13].data = resp.data.st9_interface
                option.series[14].data = resp.data.st10_high
                option.series[15].data = resp.data.st10_low
                option.series[16].data = resp.data.st10_direction
                option.series[17].data = resp.data.st10_presshigh
                option.series[18].data = resp.data.st10_presslevel
                option.series[19].data = resp.data.st11_presslow
                option.series[20].data = resp.data.st11_presslevel
                ...
                option.series[1].data = resp.data.production_productivity
                option.series[2].data = resp.data.production_efficiency_target
                option.series[3].data = resp.data.st1up
                option.series[4].data = resp.data.st3_high
                option.series[5].data = resp.data.st3_low
                option.series[6].data = resp.data.st3up_height
                option.series[7].data = resp.data.st6_high
                option.series[8].data = resp.data.st6_low
