        ...
        <div class="white_card mb_30 shadow pt-4">
            <div class="white_card_body">
                <div class="QA_section">
                    <div>
                        <form action="{{route('mrp.process-update',$process->id)}}" method="post">
                            @method('patch')
                            @csrf
                            <div class="form-group">
                                <label for="">Process Code</label>
                                <input type="text" value="{{$process->process_code}}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$process->process_name}}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="{{$process->process_time }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control js-example-basic-multiple @error('machine_id') is-invalid @enderror" name="machine_id[]"
                                        ...
                                        <option value="{{ $machine->id }}"
                                            {{ in_array($machine->id, old('machine_id') ?? $process->processMachines->pluck('id')->toArray()) ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <textarea 
                                    class="form-control @error('description') is-invalid @enderror" name="description">{{$process->description}}</textarea>
                                @error('description')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
