                        ...
                        <table class="table lms_table_active3 ">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Running Operation</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$shift->running_operation}}</td>
                                    <td>{{$shift->status}}</td>
                                    <td>{{$shift->description}}</td>
                                    <td>
                                        <div class="action_btns d-flex">
                                            @if (auth()->user()->can('shift-edit'))
                                            <a href="{{route('mrp.shift-edit',$shift->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                            @endif
                                            @if (auth()->user()->can('shift-delete'))
                                            <a href="" onclick="deleteData(event,{{$shift->id}},'{{$shift->shift_name}}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    var urlDelete = `{{route('mrp.shift-delete')}}`
