                ...
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            <a href="{{route('mrp.supplier-create')}}" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (auth()->user()->can('supplier-edit'))
                                            <a href="{{route('mrp.supplier-edit',$supplier->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                            @endif
                                            @if (auth()->user()->can('supplier-delete'))
                                            <a href="" onclick="deleteData(event,{{$supplier->id}},'{{$supplier->supplier_name}}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    var urlDelete = `{{route('mrp.supplier-delete')}}`
