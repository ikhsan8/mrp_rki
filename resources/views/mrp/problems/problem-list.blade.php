                ...
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            <a href="{{route('mrp.problem-create')}}" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex">
                                            @if (auth()->user()->can('problem-edit'))
                                            <a href="{{route('mrp.problem-edit',$problem->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                            @endif
                                            @if (auth()->user()->can('problem-edit'))
                                            <a href="" onclick="deleteData(event,{{$problem->id}},'{{$problem->problem_name}}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    var urlDelete = `{{route('mrp.problem-delete')}}`
