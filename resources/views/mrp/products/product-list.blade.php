                ...
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            <a href="{{route('mrp.product-create')}}" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (auth()->user()->can('product-edit'))
                                            <a href="{{route('mrp.product-edit',$product->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                            @endif
                                            @if (auth()->user()->can('product-delete'))
                                            <a href="" onclick="deleteData(event,{{$product->id}},'{{$product->product_name}}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
