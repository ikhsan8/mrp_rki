...
{{-- <div class="col-sm-6">
    <div class="box">
        ...
        <form action="{{ route('import.place') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            @if (auth()->user()->can('place-create'))
                            <a href="{{route('mrp.place-create')}}" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex">
                                            ...
                                            <a href="{{route('mrp.place-edit',$place->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                            @endif
                                            @if (auth()->user()->can('place-delete'))
                                            <a href="" onclick="deleteData(event,{{$place->id}},'{{$place->place_name}}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    var urlDelete = `{{route('mrp.place-delete')}}`
