        ...
        <div class="white_card mb_30 shadow pt-4">
            <div class="white_card_body">
                <div class="QA_section">
                    <div>
                        <form action="{{route('mrp.counter_measure-store')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="">Counter Measure Code</label>
                                <input type="text" value="{{old('cm_code')}}"
                                ...
                                <input type="text" value="{{old('cm_name')}}"
                                    ...
                                    <select class="form-control @error('problem_id') is-invalid @enderror" name="problem_id">
                                        ...
                                        @foreach ($problems as $problem)
                                            <option value="{{ $problem->id }}"
                                                {{ old('problem_id') == $problem->id ? 'selected' : '' }}>
