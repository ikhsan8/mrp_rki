...
{{-- <div class="col-sm-6">
    <div class="box">
        ...
        <form action="{{ route('import.material') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            <a href="{{route('mrp.material-create')}}" >
                        ...
                        <table class="table lms_table_active3 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$material->material_code ?? 'N/A'}}</td>
                                    <td>{{$material->material_name ?? 'N/A'}}</td>
                                    <td>{{$material->part_number ?? 'N/A'}}</td>
                                    <td>{{$material->unit->unit_name ?? 'N/A'}}</td>
                                    <!-- <td>{{$material->price}}</td> -->
                                    <td>{{$material->supplier->supplier_name ?? 'N/A'}}</td>
                                    <td>
                                        <div class="action_btns d-flex">
                                            <a href="{{route('mrp.material-edit',$material->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                            <a href="" onclick="deleteData(event,{{$material->id}},'{{$material->material_name}}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
...
<script>
    ...
    var urlDelete = `{{route('mrp.material-delete')}}`
