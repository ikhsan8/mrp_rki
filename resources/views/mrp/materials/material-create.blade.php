            ...
            <div class="white_card mb_30 shadow pt-4">
                <div class="white_card_body">
                    <div class="QA_section">
                        <div>
                            <form action="{{ route('mrp.material-store') }}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" value="{{ old('material_name') }}"
                                            class="form-control @error('material_name') is-invalid @enderror"
                                            name="material_name">
                                        @error('material_name')
                                            <span class="text-danger">*Material Name Wajib Diisi!</span>
                                        @enderror
                                        <br>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('part_number') }}"
                                            ...
                                            <label for="">Dimension Long(CM)</label>
                                            <input type="number" min="0" value="{{ old('dim_long') }}"
                                            ...
                                            @enderror
                                            <br>
                                            <label for="">Dimension Width(CM)</label>
                                            <input type="number" min="0" value="{{ old('dim_width') }}"
                                            ...
                                            @enderror
                                            <br>
                                            <label for="">Dimension Height(CM)</label>
                                            <input type="number" min="0" value="{{ old('dim_height') }}"
                                            ...
                                            <input type="number" min="0" value="{{ old('dim_weight') }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('colour') }}" 
                                            ...
                                            <input type="number" min="0" value="{{ old('price') }}" step="0.1"
