            ...
            <div class="white_card mb_30 shadow pt-4">
                <div class="white_card_body">
                    <div class="QA_section">
                        <div>
                            <form action="{{ route('mrp.delivery.delivery_planning.delivery_planning-store') }}"
                                method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('do_code') }}"
                                            ...
                                            <input type="text"
                                                class="form-control digits minMaxExample @error('do_date') is-invalid @enderror"
                                                id="" name="do_date" autocomplete="off">
                                            @error('do_date')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <br>
                                            ...
                                            <input type="text"
                                                class="form-control digits minMaxExample @error('delivery_date') is-invalid @enderror"
                                                id="" name="delivery_date" autocomplete="off">
                                            @error('delivery_date')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <br>
