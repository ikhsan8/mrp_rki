            ...
            <div class="white_card mb_30 shadow pt-4">
                <div class="white_card_body">
                    <div class="QA_section">
                        <div>
                            <form action="{{ route('mrp.machine-store') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="">Machine Code</label>
                                            <input type="text" value="{{ old('machine_code') }}"
                                            ...
                                            <input type="text" value="{{ old('machine_name') }}"
                                            ...
                                            <input type="text" value="{{ old('brand') }}"
                                            ...
                                            <input type="number" min="0" value="{{ old('capacity') }}"
