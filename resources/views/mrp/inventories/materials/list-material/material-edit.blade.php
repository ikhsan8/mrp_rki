...
<div class="white_card mb_30 shadow pt-4">
    <div class="white_card_body">
        <div class="QA_section">
            <div class="row ">
                <div class="col-xl-6">
                    <form action="{{route('mrp.inventory_material-update',$inven_material->id)}}" method="post">
                        @method('patch')
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control @error('material_id') is-invalid @enderror" name="material_id" id="material_id">
                                ...
                                <option value="{{ $material->id }}"
                                    {{ ((old('material_id') ?? $inven_material->material->id) == $material->id) ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$inven_material->initial_stock}}" onkeyup="changeStock()"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $inven_material->lot_material }}" class="form-control digits datepicker-here 
                                        @error('lot_material') is-invalid @enderror" id="" data-language="en"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="{{ $inven_material->target_day }}" id="target_day"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" onkeyup="changeTarget()" value="{{ $inven_material->qty_target }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" readonly value="{{ $inven_material->total_target_day }}"
                                id="total_target_day"
                ...
                <div class="col-xl-6">
                    <div class="form-group">
                        ...
                        <input type="number" min="0" value="{{ $inven_material->target_min }}" id="target_min"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" value="{{ $inven_material->target_max }}" id="target_max"
                    ...
                    {{-- <div class="form-group">
                                    ...
                                    <input type="number" min="0" value="{{ $inven_material->stock }}" readonly id="stock"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                        name="description">{{$inven_material->description}}</textarea>
                    @error('description')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
