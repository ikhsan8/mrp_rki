                ...
                <div class="QA_section">
                    ...
                    <div class="QA_table mb_30">
                        ...
                        <table class="table lms_table_active3 ">
                            ...
                            <tbody>
                                @foreach ($material_incomings as $material_out_sortir)
                                
                                <tr>
                                    <th scope="row">{{$loop->iteration}}</th>
                                    <td>{{$material_out_sortir->inventoryMaterialList->material->material_name ?? "N/A"}}</td>
                                    <td>{{$material_out_sortir->inventoryMaterialList->material->part_number?? "N/A"}}</td>
                                    
                                    <td>{{$material_out_sortir->sortir ?? "N/A"}}</td>
                                    <td>{{$material_out_sortir->inventoryMaterialList->material->dim_long?? "N/A"}}</td>
                                    <td>{{$material_out_sortir->inventoryMaterialList->material->dim_width?? "N/A"}}</td>
                                    <td>{{$material_out_sortir->inventoryMaterialList->material->dim_height?? "N/A"}}</td>
                                    <td>{{$material_out_sortir->inventoryMaterialList->material->dim_weight?? "N/A"}}</td>
                                    
                                    <td>{{$material_out_sortir->description}}</td>
