...
<div class="row ">
    ...
    <div class="col-lg-3 col-md-6" onclick="location.href='{{ route('mrp.material-out-list')}}'">
        <div class="box card">
            <div class="box-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column tx-xs-medium">
                        <span class="text-dark tx-sm-16-force">Stock Out Production</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-6" onclick="location.href='{{ route('mrp.material-sortir-list')}}'">
        <div class="box card">
            <div class="box-body">
                <div class="d-flex align-items-center">
