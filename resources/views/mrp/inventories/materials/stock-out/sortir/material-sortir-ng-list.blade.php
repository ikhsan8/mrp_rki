                    ...
                    <div class="QA_section">
                        <div class="white_box_tittle list_header">
                            ...
                            <div class="box_right d-flex lms_block">
                                ...
                                <a href="{{ route('mrp.material-sortir-create-sortir-ng') }}">
                        ...
                        <div class="QA_table mb_30">
                            ...
                            <table class="table lms_table_active3 ">
                                ...
                                <tbody>
                                    @foreach ($material_sortir_ng as $material_sortir)
                                    ...
                                    <td>{{$material_sortir->qty_ng ?? "N/A"}}</td>
                                    <td>{{$material_sortir->employee->employee_name ?? "N/A"}}</td>
                                    <td>{{$material_sortir->description}}</td>
                                    <td>
                                        <div class="action_btns d-flex">
                                            <a href="{{route('mrp.material-sortir-edit-sortir-ng',$material_sortir->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
...
@push('js')
    ...
    <script>
        ...
        var urlDelete = `{{ route('mrp.material-sortir-delete-sortir-ng') }}`
