                    ...
                    <div class="QA_section">
                        <div class="white_box_tittle list_header">
                            ...
                            <div class="box_right d-flex lms_block">
                                ...
                                <a href="{{ route('mrp.material-sortir-create-sortir-ok') }}">
                        ...
                        <div class="QA_table mb_30">
                            ...
                            <table class="table lms_table_active3 ">
                                ...
                                <tbody>
                                    @foreach ($material_sortir_ok as $material_sortir)
                                        
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{$material_sortir->date ?? "N/A"}}</td>
                                    ...
                                    <td>{{$material_sortir->qty_ok ?? "N/A"}}</td>
                                    <td>{{$material_sortir->employee->employee_name ?? "N/A"}}</td>
                                    <td>{{$material_sortir->description}}</td>
                                    <td>
                                        <div class="action_btns d-flex">
                                            <a href="{{route('mrp.material-sortir-edit-sortir-ok',$material_sortir->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                            <a href="" onclick="deleteData(event,{{$material_sortir->id}},'{{$material_sortir->inventoryMaterialList->material->material_name}}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
...
@push('js')
    ...
    <script>
        ...
        var urlDelete = `{{ route('mrp.material-sortir-delete-sortir-ok') }}`
