            ...
            <div class="white_card mb_30 shadow pt-4">
                <div class="white_card_body">
                    <div class="QA_section">
                        <div>
                            <form action="{{ route('mrp.product-sortir-store') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input  type="number" min="0" value="{{ old('qty_sortir') }}" id="qty_sortir" onkeyup="changeStock()"
