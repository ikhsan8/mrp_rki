                    ...
                    <div class="QA_section">
                        <div class="white_box_tittle list_header">
                            ...
                            <div class="box_right d-flex lms_block">
                                ...
                                <a href="{{ route('mrp.product-sortir-create-sortir-ng') }}">
                        ...
                        <div class="QA_table mb_30">
                            ...
                            <table class="table lms_table_active3 ">
                                ...
                                <tbody>
                                    @foreach ($product_sortir_ng as $product_sortir)
                                ...
                                <tr>
                                    ...
                                    <td>{{$product_sortir->qty_ng ?? "N/A"}}</td>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex">
                                            <a href="{{route('mrp.product-sortir-edit-sortir-ng',$product_sortir->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
