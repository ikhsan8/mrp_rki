            ...
            <div class="white_card mb_30 shadow pt-4">
                <div class="white_card_body">
                    <div class="QA_section">
                        ...
                        <div>
                            <form action="{{ route('mrp.report_inventory_material-list') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-5">
                            ...
                            <table class="table report_material">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $material->date_in }}</td>
                                        <td>{{ $material->date_out }}</td>
                                        <td>{{ $material->part_name }}</td>
                                        <td>{{ $material->part_number }}</td>
                                        <td>{{ $material->incoming ?? '0' }}</td>
                                        <td>{{ $material->outgoing ?? '0' }}</td>
                                        <td>{{ $material->sortir }}</td>    
                                        <td>{{ $material->sortir_ok }}</td>    
                                        <td>{{ $material->sortir_ng }}</td>    
