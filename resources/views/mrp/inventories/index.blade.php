...
<div class="row ">
    <div class="col-lg-3 col-md-6" id="material" onclick="location.href='{{ route('mrp.inventory-material-index')}}'">
        <div class="box card">
            <div class="box-body">
    ...
    <div class="col-lg-3 col-md-6" id="product" onclick="location.href='{{ route('mrp.inventory-product-index')}}'">
        <div class="box card">
            <div class="box-body">
                <div class="d-flex align-items-center">
...
@push('js')
    ...
    {{-- SEARCH --}}
    <script>
        const dictionary = [ 'material','product'];
