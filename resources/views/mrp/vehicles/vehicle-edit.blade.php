        ...
        <div class="white_card mb_30 shadow pt-4">
            <div class="white_card_body">
                <div class="QA_section">
                    <div>
                        <form action="{{route('mrp.vehicle-update',$car->id)}}" method="post">
                            @method('patch')
                            @csrf
                            <div class="form-group">
                                <label for="">Car Code</label>
                                <input type="text" value="{{$car->car_code}}"
                                ...
                                <input type="text" value="{{$car->driver}}"
                                ...
                                <textarea 
                                    class="form-control @error('description') is-invalid @enderror" name="description">{{$car->description}}</textarea>
                                @error('description')
