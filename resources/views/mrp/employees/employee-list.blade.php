                ...
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            <a href="{{route('mrp.employee-create')}}" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex">
                                            ...
                                            <a href="{{route('mrp.employee-edit',$employee->id)}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                            @endif
                                            @if (auth()->user()->can('employee-delete'))
                                            <a href="" onclick="deleteData(event,{{$employee->id}},'{{$employee->employee_name}}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    var urlDelete = `{{route('mrp.employee-delete')}}`
