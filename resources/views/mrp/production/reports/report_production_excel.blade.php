<table style="font-size: 11px;">
    ...
    <tbody>
        <tr>
            ...
            <td style="width: 2%">: <span style="font-weight: ">01-PR-FM-085 </span></td>
        ...
        <tr>
            ...
            <td style="width: 20px">: <span style="font-weight: ">00 </span></td>
        ...
        <tr>
            ...
            <td>: <span style="font-weight: width: 40px">- </span></td>
        ...
        <tr>
            ...
            <td style="width: 40px">: <span style="font-weight: s">1/4 </span></td>
