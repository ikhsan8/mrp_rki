                    ...
                    <div class="QA_section">
                        ...
                        <div class="white_box_tittle list_header">
                            ...
                            <div class="box_right d-flex lms_block">
                                <a href="{{ route('mrp.report.report-export') }}">
                                ...
                                <div class="btn btn-primary ml-10 btn-sm" id="theButton">
                                    <i class="fas fa-file-pdf"></i>
                                    FULL
                                </div>
                            </div>
                            ...
                            <table class="report table-bordered" style="font-size: 11px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="56px" rowspan="2">31-Mar-21</td>
                            ...
                            <div class="table-responsive" style="padding-bottom:10px;" id="style-1">
                                ...
                                <table class="report table-bordered"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="10px">10</td>
                                            <td colspan="2" width="90px" style="width:150px;white-space:nowrap">Driving &
                                                Powder</td>
                                        ...
                                        @for ($i = 0; $i < 6; $i++)
                                            {{-- MESIN 1 --}}
                                            <tr>
                                                <td rowspan="6" style="font-size: 7px"> UP#{{ $i }}</td>
                                                <td width="90px" rowspan="6">
                                                    <span style="display: block">
                                                        15262-OYO040
                                                    </span>
                                                    <span style="font-size: 25px">NR #{{ $i }}</span>
                                                </td>
