...
<div class="row ">
    <div class="col-lg-3 col-md-6" id="planning" onclick="location.href='{{ route('mrp.production.planning-list')}}'">
        <div class="box card">
            <div class="box-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column tx-xs-medium">
                        <span class="text-dark font-weight-bold" style="font-size: 16px;">Planning</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-6" id="production" onclick="location.href='{{ route('mrp.production.production-list')}}'">
        <div class="box card">
            <div class="box-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column tx-xs-medium">
                        <span class="text-dark font-weight-bold" style="font-size: 16px;">Production</span>
                    </div>
                </div>
            </div>
        </div>
