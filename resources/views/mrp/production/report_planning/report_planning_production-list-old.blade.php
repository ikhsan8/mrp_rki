            ...
            <div class="white_card mb_30 shadow pt-4">
                <div class="white_card_body">
                    <div class="QA_section">
                        ...
                        <div>
                            <form action="{{ route('mrp.report_planning-listt') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                    ...
                    <div class="QA_section">
                        <div class="white_box_tittle list_header">
                            ...
                            <div class="box_right d-flex lms_block">
                                <a href="{{ route('mrp.report_planning-export', $start_date) }}">
                            ...
                            <div class="">
                                ...
                                <table class="report table-bordered"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="10px">10</td>
                                            <td colspan="2" width="90px" style="width:150px;white-space:nowrap">{{$data['process_name']}}</td>
                                        ...
                                        @endif
                                            ...
                                            <tr>
                                                <td rowspan="" style="white-space:nowrap;font-size:9px">Shift 2</td>
                                                <td><span class="pan plan"> Plan </span></td>
