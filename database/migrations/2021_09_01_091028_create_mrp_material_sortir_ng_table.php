...
class CreateMrpMaterialSortirNgTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mrp_material_sortir_ng', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mrp_material_sortir_ng');
    }
}
